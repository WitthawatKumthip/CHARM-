...
// เลือกวันคี่เพราะวันเบิกเงิน (1 และ 15) เป็นเลขคี่ทั้งคู่พอดี ยังได้แจ้งตรงวันเป๊ะเหมือนเดิม — ผลข้างเคียงคือเตือนถ่ายรูปวันเสาร์ (ปกติทุกสัปดาห์)
// จะมาได้แค่สัปดาห์เว้นสัปดาห์ (เฉพาะเสาร์ที่ตรงวันคี่) ถ้าไม่โอเคเรื่องนี้บอกได้ ปรับให้ยกเว้นเฉพาะวันเสาร์ให้ส่งทุกครั้งได้
//
